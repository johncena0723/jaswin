...
<table align='center' id='searchform' width='30%' cellspacing='0' cellpadding='5' border='2%' height='10%'>
                    ...
                    if ($sound[$j]['key'] == 'OFFER_ID')
                    {
                       ...
                       $params_1  = array('keyStr' => $key_string_1,
							...
							
                        {
							...
							<?php
							//	echo "<table align='center' id='searchform' width='30%' cellspacing='0' cellpadding='5' border='2%' height='10%'>
